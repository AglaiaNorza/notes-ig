...
\begin{defbox}{Problema semi-decidibile}{}
...
\begin{defbox}{Problema computabilmente enumerabile}{}
...
\begin{defbox}{Teoria semanticamente completa}{}
...
\begin{defbox}{Dimostrazione nel calcolo proposizionale}{}
...
\begin{defbox}{Teorema}{}
    \( A \) è un teorema se:
    \[ \vdash A \]
    ovvero \( A \) è dimostrabile a partire ``semplicemente'' dagli assiomi.
\end{defbox}

\begin{thmbox}{Correttezza}{}
    \[ \vdash A \implies \vDash A \]
    \[ T \vdash A \implies T \vDash A \]
\end{thmbox}

La dimostrazione è semplice: \( \vdash A \) significa che \( A \) è dimostrabile a partire dagli assiomi logici (che sono verità logiche), e il Modus Ponens preserva le verità logiche (discorso facilmente estendibile per \( T \vdash A \implies T \vDash A\)).
...
\begin{thmbox}{Teorema di completezza}{}
    \[ \vdash A \iff \vDash A \]
