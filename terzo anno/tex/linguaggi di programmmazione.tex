...
Differenza tra eager statico e dinamico:
...
\item \textbf{Assegnamento ([assign])}:
    \begin{prooftree}
        ...
        \AxiomC{$E \vdash V, S \stackrel{l}{\leadsto} l$}
        \BinaryInfC{$E \vdash V := M, S \stackrel{p}{\leadsto} S[l \mapsto v]$}
    \end{prooftree}
...
\end{center}
    ...
    \begin{prooftree}
        \AxiomC{$E[y \mapsto \langle x, p, E \rangle] \vdash q, S \stackrel{p}{\leadsto} S'$}
...
\begin{cdefframe}{DeepGreenLight}{DeepGreen}{Regola Call-by-Value}{}
    \begin{prooftree}
        \AxiomC{$E \vdash M, S \stackrel{M}{\leadsto} v$}
        \AxiomC{$E'[x \mapsto l] \vdash p, S[l \mapsto v] \stackrel{p}{\leadsto} S'$}
        \RightLabel{(*)}
        \BinaryInfC{$E \vdash \text{call } y(M), S \stackrel{p}{\leadsto} S'$}
    \end{prooftree}
    \vspace{-0.5em}
    {\small (*) dove $E(y) = \langle x, p, E' \rangle$ e $l$ è una locazione \textbf{nuova} ($l \notin dom(S)$).}
\end{cdefframe}
...
\begin{cdefframe}{DeepGreenLight}{DeepGreen}{Regola Call-by-Reference}{}
    ...
    \begin{prooftree}
        \AxiomC{$E \vdash V, S \stackrel{l}{\leadsto} l$}
        \AxiomC{$E'[x \mapsto l] \vdash p, S \stackrel{p}{\leadsto} S'$}
        \RightLabel{(*)}
...
\begin{cdefframe}{DeepGreenLight}{DeepGreen}{Regole Call-by-Name}{}
    \begin{prooftree}
        \AxiomC{$E'[x \mapsto (V, E)] \vdash p, S \stackrel{p}{\leadsto} S'$}
