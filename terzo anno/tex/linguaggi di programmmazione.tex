...
\vspace{-1.5em}
\begin{prooftree}
    \AxiomC{$x: int \to bool \vdash x: int \to bool$}
    \AxiomC{$\Gamma \vdash 5: int$}
    \BinaryInfC{$x: int \to bool \vdash x\ 5: bool$}
    \UnaryInfC{$\emptyset \vdash fn\ x: int \to bool \Rightarrow x\ 5 : (int \to bool) \to bool$}

    \AxiomC{$y: int \vdash true: bool$}
    \UnaryInfC{$\emptyset \vdash fn\ y: int \Rightarrow true: bool$}

    \BinaryInfC{$(fn\ x: int \to bool \Rightarrow x\ 5)\ (fn\ y: int \Rightarrow true): bool$}
\end{prooftree}
...
\UnaryInfC{$\emptyset \vdash fn \ x:A \Rightarrow xx: A\to B$}
\DisplayProof
\]
...
\begin{cdefframe}{DeepGreenLight}{DeepGreen}{Regole di inferenza}{}
    ...
    \subitem permette di astrarre sul tipo, creando un termine polimorfo
   ...
   \end{prooftree}
    ...
    \subitem permette di istanziare un termine polimorfo con un tipo concreto \( B \)
\end{itemize}
\end{cdefframe}
