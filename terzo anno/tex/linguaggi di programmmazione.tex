...
Nella logica classica esistono tautologie che non sono dimostrabili nella logica intuizionista e, di conseguenza, corrispondono a tipi che non possono essere abitati da un programma puro. Questo accade perché l'informatica richiede una costruzione esplicita del risultato.
...
Ecco esempi di formule logicamente valide in logica classica ma computazionalmente impossibili (senza effetti collaterali o eccezioni):
