...
\usepackage{./../packages/newnewboxes}
...
\begin{gbox}{insieme unità e funzione nullaria}
...
\begin{gbox}[colback=DeepTealLight]{lazy statico}
...
\begin{cdefbox}{DeepGreenLight}{DeepGreen} {Semantica eager dinamica di \( Fun \)}{}
...
\begin{cdefbox}{DeepGreenLight}{DeepGreen}{Semantica eager statica di \( Fun \)}{}
    \begin{center}
    [\( fn \) statico eager]
\end{center}
\vspace{-1em}
...
\begin{cbox}{DeepGreenLight}{DeepGreen}{Curryficazione in \( Fun \)}
...
\begin{defbox}{Grammatica del linguaggio \( Imp \)}{}
    \[ 
...
\begin{cbox}{DeepBlueLight}{DeepBlue} {Domini semantici}
...
\begin{cdefbox}{DeepGreenLight}{DeepGreen}{Semantiche operazionali}{}
...
\begin{defbox}{Grammatica del linguaggio \( All \)}{}
    \[ 
        k ::= 0 \mid 1 \mid \dots \mid true \mid false
    \]
    \[ 
