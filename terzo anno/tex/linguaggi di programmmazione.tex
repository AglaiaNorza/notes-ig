...
\begin{defbox}[colframe=ForestGreen, colback=DeepGreenLight]{Scoping}{}
...
\begin{gbox}[colframe=BrickRed, colback=white]{``commutatività'' in \( Exp \)}
    In \( Exp \), si ha:
...
\begin{itemize}
    ...
    \item quindi, le due espressioni sono equivalenti solo se \( y \) non compare libera (non ri-definita) in \( L \)
\end{itemize}
\end{gbox}
