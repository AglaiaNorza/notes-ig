...
Termini e tipi operano quindi su livelli distinti e i simboli $\forall$ e $\Lambda$ gestiscono l'interazione tra questi due mondi.
...
Utilizziamo la sintassi \( \Lambda X.M \) per dichiarare la variabile di tipo \( X \) all'interno dell'espressione \( M \).
