...
Si valuta il programma \( q \) nell'ambiente in cui a \( y \) viene associata la \textit{chiusura} formata da parametro \( x \) e corpo del programma \( p \) - si salva anche l'ambiente corrente (di definizione della procedura), garantendo quindi lo scoping statico.
