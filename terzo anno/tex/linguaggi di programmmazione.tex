...
\begin{cdefframe}{DeepGreenLight}{DeepGreen}{Regole di inferenza}{}
    ...
    \begin{itemize}
        \item ricordiamo che \( X \in \text{free}(\Gamma)\) se non compare in \( \Gamma \) oppure se compare, ma non ``legato'' 
            \subitem (es. in \( x:X \) è libero, in  \( y: \forall X.X\to X \) è ``legato'')
    \end{itemize}
