...
\begin{thmframe}{Omomorfismo tra algebre con stessa segnatura}{teo-om}
...
\begin{defframe}{Combinatore di punto fisso F}{}
    (``combinatore paradossale Y'' di Haskel Curry)
    Nel lambda calcolo, definiamo come \textbf{combinatore di punto fisso} la seguente funzione F:
...
\begin{prooftree}
  ...
  \UnaryInfC{\(\{A\}\; \textbf{while } (b \ge y) \; \textbf{do}\; b := b - y;\; a := a+1\; \{A \land \neg(b \ge y)\}\)}
\end{prooftree}
}
)
