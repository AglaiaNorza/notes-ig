...
\begin{gframe}{}
    ...
    \begin{itemize}
        \item \textbf{Astrazione sui Termini ($fn$):}
        \[ fn \ x : A \Rightarrow M \]
        È una funzione $Termine \to Termine$. Accetta un valore a runtime e restituisce un valore calcolato.

        \item \textbf{Astrazione sui Tipi ($\Lambda$):}
        \[ \Lambda X . M \]
        È una funzione $Tipo \to Termine$. Accetta un tipo in fase di specializzazione e restituisce un nuovo termine eseguibile.
    \end{itemize}
\end{gframe}
