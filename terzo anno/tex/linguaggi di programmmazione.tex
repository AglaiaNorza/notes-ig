...
\begin{enumerate}
    ...
    valuto \( M \) per capire cosa sto chiamando - ottengo la chiusura composta dal parametro formale \( x \) e dal corpo del codice \( M' \).
...
\begin{cdefframe}{DeepGreenLight}{DeepGreen}{Semantica operazionale di \( Fun \) lazy dinamico}{}
    ...
    \end{prooftree}
\end{cdefframe}
\begin{cdefframe}{BrightGreenLight}{BrightGreen}{Semantica operazionale di \( Fun \) lazy statico}{}
