...
\begin{itemize}
    ...
    \item \textbf{Mancanza di Punto Fisso:} in F2 puro non è possibile tipare il combinatore di punto fisso ($Y$) o funzioni che si auto-applicano ($xx$), quindi la ricorsione generale non è supportata direttamente.
\end{itemize}
