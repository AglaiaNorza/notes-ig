...
\begin{itemize}
    ...
    \AxiomC{}
    \RightLabel{$[\alpha]$}
    \UnaryInfC{$fn \ x \implies M = fn \ y \implies [y/x]M$}
    \DisplayProof
    \]
    ...
    \AxiomC{}
    \RightLabel{$[\beta]$}
    \UnaryInfC{$(fn \ x \implies M) N = [N/x]M$}
    \DisplayProof
    \]
...
\item regola di $\lambda$-astrazione:
    ...
    \UnaryInfC{$fn\ x \implies M = fn \ x \implies N$}
    \DisplayProof
    \]
\end{itemize}
...
\begin{gframe}{}
    ...
    Per esempio, se applicassimo \( [y/x] fn \ y \implies x \) senza fare attenzione, otterremmo \( fn \ y \implies y \), che ci permetterebbe di dimostrare affermazioni false.

Se per esempio abbiamo
\[ fn \ y \implies (fn \ x \implies fn \ y \implies x) \underline{y} \]
...
Per esempio, visto che \( fn \ y \implies x \) è \( \alpha\)-equivalente a \( fn \ z \implies x \), otteniamo:
...
\begin{enumerate}
    ...
    \[ 
        \AxiomC{\( Q(0) \quad Q(y)\implies Q(succ \ y) \)}
...
\begin{itemize}
    ...
    \item \textbf{Passo} $R(y) \implies R(succ \ y)$:
...
\[ 
    \AxiomC{$R(0) \quad R(y)\implies R(succ \ y)$}
...
\[ 
    \AxiomC{$P(0) \quad P(n)\implies P(succ \ n)$}
...
\begin{defframe}{Proposizioni come Tipi}{}
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        Implicazione ($A \Rightarrow B$) & Tipo Funzione ($A \to B$) \\
