...
\begin{enumerate}
    \item \textbf{C.B.} (\(n=0\)): \(\texttt{plus}\; 0\; m = \mathtt{plus}\; m\; 0\).
    \begin{itemize}
...
\( F1 \) è un sistema di \textit{secondo ordine}, ovvero senza parametrizzazione o astrazione sui tipi.
...
\begin{defframe}{Grammatica di \( F1 \)}{}
    ...
    \begin{itemize}
        ...
        \item \( x \in Var\) indica una \textbf{variabile}
    \end{itemize}
\end{defframe}
