...
\subsection*{Esempio di inferenza}
...
\begin{defframe}{Definizione: Istanza Generica ($\succ$)}{}
...
\begin{itemize}
    \item Dato $\sigma = \forall X. X \to X$, il tipo $int \to int$ è istanza generica ($\sigma \succ int \to int$).
    \item Dato $\sigma = \forall X, Y. X \to Y$, lo schema $\forall Z. (int \to Z) \to bool$ è istanza generica.
